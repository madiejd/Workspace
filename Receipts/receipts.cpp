...
int main( )
{
	...
	for (int i=0; i<40; i++) ages.insert(381-17*i);
    cout << ages.size() << endl; // should be 40 items
	for (int i=0; i<40; i++) ages.remove(i);
	cout << ages.size() << endl;
	for (int i=0; i<4; i++)  ages.remove_by_receipt(i);
	cout << ages.size() << endl;
	for (int i=0; i<4; i++)  ages.remove_by_receipt(381-17*i);
	cout << ages.size() << endl;
	...
	small = extra;
	for (int i=0; i<40; i++) extra.insert(381-17*i);
	cout << extra.size() << endl;
	cout << small.size() << endl;
